import { collection, getDocs, addDoc, removeDoc } from "firebase/firestore";
      ...
      <div className="w-full max-w-[500px] mx-auto shadow-lg p-5 mb-10">
        <form onSubmit={handleRemovePost}>
          <input
            type="text"
            name="postId"
            className="w-full p-3 mb-5 border border-gray-200 rounded rounded-lg outline-none focus:border-blue-500"
            placeholder="Enter your title"
